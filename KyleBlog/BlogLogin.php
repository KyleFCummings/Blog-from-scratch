...
<html lang="en">
    ...
    <head>
        ...
        <title>Login: Blog by Kyle Cummings</title>
    ...
    <body class="login-background">
        ...
        <div class="login-body">
            <form method="post" class="login-center-form" action="login_handler.php">
                ...
                <?php 
                    if(isset($_SESSION["email_pass_error"])) {
                        echo "<div id='error_message'>" . $_SESSION["email_pass_error"] . "</div>";
                ...
                <div class="username-pass-container">
                    ...
                    <input id="name-field" type="text" name="Email" placeholder="Email" value=
                        "<?php 
                ...
                <div id="create-user-link">
                    <a href="BlogCreateUser.php">Sign up</a>
                </div>
